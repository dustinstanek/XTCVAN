...
export default class DinoGame extends GameRunner {
  ...
  async preload() {
    ...
    const spriteImageUrl = 'https://s3.us-west-1.wasabisys.com/scripts-and-codes/XTCVAN/20230323/assets/sprite.png'
    const fontUrl = 'https://s3.us-west-1.wasabisys.com/scripts-and-codes/XTCVAN/20230323/assets/PressStart2P-Regular.ttf'

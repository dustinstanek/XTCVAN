...
export default class DinoGame extends GameRunner {
  ...
  async preload() {
    ...
    // Replace these URLs with your Wasabi URLs
    const spriteImageUrl =
      "https://s3.us-west-1.wasabisys.com/scripts-and-codes/XTCVAN/20230323/assets/sprite.png";
    const fontUrl =
      "https://s3.us-west-1.wasabisys.com/scripts-and-codes/XTCVAN/20230323/assets/PressStart2P-Regular.ttf";

    const [spriteImage] = await Promise.all([
      loadImage(spriteImageUrl),
      loadFont(fontUrl, "pressStart2p", "regular"),
    ]);
  ...
  endGame() {
    ...
    this.canvasCtx.fillRect(
      this.width / 3.1,
      this.height / 3 - paddingOne,
      saveButtonWidth + saveButtonWidth,
      saveButtonHeight + padding / 4
    );
    this.paintText(
      "G A M E  O V E R",
      this.width / 2,
    ...
    this.paintText(
      ...
      this.height - iconSprite.h - padding / 2,
      {
        font: "pressStart2p",
        size: "10px",
        align: "center",
    ...
    this.canvasCtx.fillStyle = "#000000";
    this.canvasCtx.fillRect(
      saveButtonX / 4 + paddingOne + padding / 2,
      saveButtonY,
      saveButtonWidth,
      saveButtonHeight
    );

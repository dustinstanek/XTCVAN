...
export default class DinoGame extends GameRunner {
  ...
  constructor() {
    ...
    window.addEventListener('resize', () => {
      ...
      this.resizeCanvas(this.canvas, scale)
    })
  }
  ...
  resizeCanvas(canvas, scale) {
    ...
    // You can change the aspectRatio to your desired value
    const aspectRatio = 16 / 9
    
    // Calculate new canvas dimensions based on aspect ratio and max dimensions
